...
# Function 'addCharmci' is used to add custom build commands for a Charm++ ci file
function(addCharmci CHARMci)
  # Arguments:
  #   CHARMci:    Name of the Charm++ ci file.

  execute_process(
	          COMMAND     ${CHARM_COMPILER} ${CMAKE_CURRENT_SOURCE_DIR}/${CHARMci}.ci
		  WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
	          )

endfunction(addCharmci)
